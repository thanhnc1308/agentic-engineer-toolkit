---
name: planning
description: Creates structured implementation plans from requirements; use when scoping non-trivial features, sequencing phases, identifying risks, and defining acceptance criteria.
