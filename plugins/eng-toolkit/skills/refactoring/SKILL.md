---
name: refactoring
description: Safely remove dead code, consolidate duplicates, and prune dependencies; use proactively when reducing codebase risk through verified, test-backed refactoring.
