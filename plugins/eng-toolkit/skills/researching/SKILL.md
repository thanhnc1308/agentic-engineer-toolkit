---
name: researching
description: Multi-source technology research across docs, GitHub, articles, and videos; use when evaluating frameworks, comparing approaches, or de-risking implementation decisions.
