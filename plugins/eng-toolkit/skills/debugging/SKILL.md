---
name: debugging
description: Systematic debugging frameworks for finding and fixing bugs; use when handling failures, tracing root causes, and verifying fixes before completion.
